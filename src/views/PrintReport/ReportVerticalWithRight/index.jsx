    ...
    return (
      <div className="report-vertical-right">
        ...
        <div className="report-vertical-right__content" ref={this.myRef}>
          <div
            className="report-vertical-right__content-report"
            style={{ backgroundImage: bgImageLink }}
          >
            <div className="report-vertical-right__content-report-edit">
          ...
          <div
            className="report-vertical-right__content-custom"
            style={{
